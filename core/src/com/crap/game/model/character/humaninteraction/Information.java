...
public class Information {
    ...
    public void setInformation(ArrayList<Human> humans) {
        ...
        for (int i = 0; i < humans.size(); i++) {
            if (humans.get(i).getName().equals("EHuman")) {
            ...
            else if(humans.get(i).getName().equals("DHuman")) {
            ...
            else if(humans.get(i).getName().equals("ITHuman")) {
            ...
            else if(humans.get(i).getName().equals("ZHuman")) {
